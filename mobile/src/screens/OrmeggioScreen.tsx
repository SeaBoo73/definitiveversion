  ...
  const moorings = [
    {
      ...
      price: '€45',
      maxLength: '20m',
      services: ['Elettricità', 'Acqua', 'WiFi', 'Sicurezza 24h'],
      rating: 4.8,
      available: true,
      image: 'https://via.placeholder.com/300x200?text=Marina+Civitavecchia'
    },
    {
      id: 2,
      name: 'Porto di Gaeta',
      ...
      price: '€38',
      maxLength: '15m',
      services: ['Elettricità', 'Acqua', 'Carburante'],
      rating: 4.6,
      available: true,
      image: 'https://via.placeholder.com/300x200?text=Porto+Gaeta'
    },
    {
      id: 3,
      name: 'Boa Campo di Mare',
      location: 'Anzio',
      type: 'boa',
      price: '€15',
      maxLength: '12m',
      services: ['Trasporto a terra'],
      rating: 4.2,
      available: false,
      image: 'https://via.placeholder.com/300x200?text=Boa+Anzio'
    },
    {
      id: 4,
      ...
      price: '€42',
      maxLength: '18m',
      services: ['Elettricità', 'Acqua', 'WiFi', 'Bar/Ristorante'],
      rating: 4.7,
      available: true,
      image: 'https://via.placeholder.com/300x200?text=Marina+Formia'
    },
  ];
