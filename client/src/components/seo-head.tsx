...
export function SEOHead({ 
  ...
  const defaultTitle = "SeaGO - Piattaforma Marittima per Noleggio Barche e Servizi Nautici in Italia";
  ...
  const defaultImage = "/attached_assets/Immagine WhatsApp 2025-07-23 ore 18.35.06_81ef1af0_1753289164694.jpg";
  ...
  useEffect(() => {
    ...
    updateOrCreateMeta('author', 'SeaGO - Piattaforma Marittima');
    ...
    updateOrCreateMeta('og:site_name', 'SeaGO', true);
...
export const seoConfigs = {
  home: {
    title: "SeaGO - Noleggio Barche e Charter Nautici in Italia | Piattaforma Marittima",
    description: "Scopri SeaGO, la piattaforma leader per noleggio barche, charter nautici e servizi marittimi in Italia. Oltre 1000 imbarcazioni disponibili, esperienze uniche sul mare.",
  ...
  esperienze: {
    title: "Esperienze Maritime Uniche in Italia | SeaGO",
    description: "Vivi esperienze maritime indimenticabili con SeaGO. Tramonti sul mare, pesca sportiva, cene a bordo, escursioni nautiche e molto altro lungo le coste italiane.",
    keywords: "esperienze maritime, escursioni in barca, pesca sportiva, tramonti sul mare, cene a bordo, attività nautiche Italia"
  },
  charter: {
    title: "Charter Nautico Professionale in Italia | SeaGO",
  ...
  ormeggio: {
    title: "Ormeggi e Porti Turistici in Italia | SeaGO",
  ...
  aiuto: {
    title: "Assistenza e Supporto Clienti | SeaGO",
    description: "Centro assistenza SeaGO: guide, FAQ, supporto clienti per noleggio barche e servizi nautici. Assistenza professionale per la tua esperienza marittima.",
