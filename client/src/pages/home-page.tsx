...
import heroImage from "@assets/ChatGPT Image 24 nov 2025, 11_22_18_1763999267045.png";
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20 md:pb-0 overflow-x-hidden">
      ...
      <section className="relative min-h-screen text-white overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-slate-900/15 via-slate-900/5 to-slate-900/20"></div>
